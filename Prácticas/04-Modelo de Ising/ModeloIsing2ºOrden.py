...
def main():
    ...
    print("MODELO DE ISING DE 2º ORDEN")
    print("->Datos:")
    ...
    print()
    print("---------------------------------------------------------------------")
    print("ESTUDIO DE LA FUNCIÓN DE CORRELACIÓN")
    print()
    print("->Datos:")
    ...
    d = np.arange(1,11)
    fig, ax = plt.subplots(1,1)
    ax.plot(d, correlacionesT15, 'o-', color='k')
    ax.plot(d, correlacionesT2, 'o-', color='b')
    ax.plot(d, correlacionesT23, 'o-', color='r')
    ax.plot(d, correlacionesT4, 'o-', color='g')
